  ...
  return (
    <div className="min-h-screen bg-bg-app">
      ...
      <main className="px-6 py-4 sm:px-10 md:px-20 lg:px-32 xl:px-48 2xl:px-64">
        {!category ? (
          <section className="rounded-xl border border-border bg-bg-surface p-6 text-center shadow-1">
          ...
          <>
            <section className="relative overflow-hidden rounded-xl border border-border bg-bg-surface shadow-1">
