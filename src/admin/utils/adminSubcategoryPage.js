...
export function getAdminSubcategoryText(lang, t) {
  return {
    ...
    nameEn: lang === "km" ? "ឈ្មោះ (អង់គ្លេស)" : "Name (English)",
    nameKm: lang === "km" ? "ឈ្មោះ (ខ្មែរ)" : "Name (Khmer)",
    slug: t.slug || "Slug",
    description: lang === "km" ? "ការពិពណ៌នា" : "Description",
    descriptionEn: lang === "km" ? "ការពិពណ៌នា (អង់គ្លេស)" : "Description (English)",
    descriptionKm: lang === "km" ? "ការពិពណ៌នា (ខ្មែរ)" : "Description (Khmer)",
    sort: lang === "km" ? "លំដាប់" : "Sort",
    status: lang === "km" ? "ស្ថានភាព" : "Status",
    subcategories: t.subcategories || "Subcategories",
    addSubcategory: lang === "km" ? "បន្ថែមប្រភេទរង" : "Add subcategory",
    create: lang === "km" ? "បង្កើត" : "Create",
    selectCategory: lang === "km" ? "ជ្រើសរើសប្រភេទមេ" : "Select category",
    ...
    addSubcategoryTitle: lang === "km" ? "បន្ថែមប្រភេទរងថ្មី" : "Add new subcategory",
